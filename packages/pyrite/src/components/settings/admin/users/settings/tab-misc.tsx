    ...
    return (
        <section class='c-users-settings-misc tab-content active'>
            <FieldText
                ...
                placeholder='...'
                value={typeof $s.admin.user === 'object' && $s.admin.user !== null && 'name' in $s.admin.user ? String($s.admin.user.name || '') : ''}
            />
            <FieldText
                ...
                placeholder='...'
                value={typeof $s.admin.user === 'object' && $s.admin.user !== null && 'password' in $s.admin.user ? String($s.admin.user.password || '') : ''}
            />
            <FieldCheckbox
                ...
                value={typeof $s.admin.user === 'object' && $s.admin.user !== null && 'admin' in $s.admin.user ? Boolean($s.admin.user.admin) : false}
            />
        </section>
    )
}
