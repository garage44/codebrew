    ...
    return (
        <section class='c-admin-group-tab-misc tab-content active'>
            <FieldText
                ...
                placeholder='...'
                value={
                    typeof $s.admin.group === 'object' && $s.admin.group !== null && '_newName' in $s.admin.group
            ...
            <FieldText
                ...
                placeholder='...'
                value={
                    typeof $s.admin.group === 'object' && $s.admin.group !== null && 'description' in $s.admin.group
            ...
            <FieldText
                ...
                placeholder='...'
                value={
                    typeof $s.admin.group === 'object' && $s.admin.group !== null && 'contact' in $s.admin.group
            ...
            <FieldText
                ...
                placeholder='...'
                value={
                    typeof $s.admin.group === 'object' && $s.admin.group !== null && 'comment' in $s.admin.group
            ...
            <FieldCheckbox
                ...
                value={
                    typeof $s.admin.group === 'object' && $s.admin.group !== null && 'allow-recording' in $s.admin.group
            ...
            <FieldMultiSelect
                ...
                value={
                    ...
                    $s.admin.group !== null &&
                    'codecs' in $s.admin.group &&
                    Array.isArray($s.admin.group.codecs)
            ...
            <FieldNumber
                ...
                value={
                    typeof $s.admin.group === 'object' && $s.admin.group !== null && 'max-history-age' in $s.admin.group
